...
" Color Variables
" ==========================
" Original >> let s:voidBlack = {'gui': '#1C1C1C', 'cterm256': '234'}
" Original >> let s:voidGray1 = {'gui': '#3E3D32', 'cterm256': '237'}
" Original >> let s:voidBlack2 = {'gui': '#262626', 'cterm256': '235'}

let s:voidBlack = {'gui': '#232627', 'cterm256': '234'}
let s:voidBlack2 = {'gui': '#373C3E', 'cterm256': '235'}
...
let s:voidRed = {'gui': '#FF0000', 'cterm256': '252'}
...
call <sid>hi('Cursor', s:voidBlack, s:voidRed, 'none')
call <sid>hi('TermCursor', s:voidBlack, s:voidRed, 'none')
call <sid>hi('TermCursorNC', s:voidBlack, s:voidRed, 'none')
...
call <sid>hi('Normal', s:voidSteel, s:none, 'none')
call <sid>hi('NormalFloat', s:voidSteel, s:voidBlack, 'none')
...
call <sid>hi('StatusLine', s:voidBlack, s:voidGray4, 'none')
call <sid>hi('StatusLineNC', s:voidGray3, s:voidBlack2, 'none')
call <sid>hi('VertSplit', s:voidBlack2, s:voidBlack, 'none')
...
call <sid>hi('SignColumn', s:none, s:voidBlack, 'none')
...
call <sid>hi('String', s:voidGreen, s:none, 'none')
call <sid>hi('Tag', s:voidSteel, s:none, 'none')
call <sid>hi('Title', s:voidSteel, s:none, 'bold')
call <sid>hi('Todo', s:voidGray3, s:none, 'inverse,bold')
call <sid>hi('Type', s:voidSteel, s:none, 'none')
call <sid>hi('Underlined', s:voidSteel, s:none, 'underline')
